...
body {
background-image:url("../images/spec18.jpg");
...
<center>
	...
	<form:form  method="post" modelAttribute = "register">
		...
		<table>
			 ...
			 <tr>
				<td><button type="button" class="btn btn-secondary">User Id:</button></td>
			...
			<tr>
				<td><button type="button" class="btn btn-secondary">Question</button></td>
			...
			<tr>
				<td><button type="button" class="btn btn-secondary">Answer:</button></td>
